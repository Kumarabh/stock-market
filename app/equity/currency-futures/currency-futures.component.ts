...
@Component({
  selector: 'app-currency-futures',
  templateUrl: './currency-futures.component.html',
  styleUrls: ['./currency-futures.component.css']
})
export class CurrencyFuturesComponent implements OnInit {
