...
@Component({
  selector: 'app-equity-delivery',
  templateUrl: './equity-delivery.component.html',
  styleUrls: ['./equity-delivery.component.css']
})
export class EquityDeliveryComponent implements OnInit {
