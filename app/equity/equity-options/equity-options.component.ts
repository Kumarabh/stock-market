...
@Component({
  selector: 'app-equity-options',
  templateUrl: './equity-options.component.html',
  styleUrls: ['./equity-options.component.css']
})
export class EquityOptionsComponent implements OnInit {
  showLots = false;
  submitted = false;
  allStates
  allBrokers
