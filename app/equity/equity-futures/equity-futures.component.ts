...
@Component({
  selector: 'app-equity-futures',
  templateUrl: './equity-futures.component.html',
  styleUrls: ['./equity-futures.component.css']
})
export class EquityFuturesComponent implements OnInit {
