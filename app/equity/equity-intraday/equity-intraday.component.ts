...
@Component({
  selector: 'app-equity-intraday',
  templateUrl: './equity-intraday.component.html',
  styleUrls: ['./equity-intraday.component.css']
})
export class EquityIntradayComponent implements OnInit {
